...
@pytest.mark.parametrize("name", ["00_colab_setup_and_conceptnet.ipynb", "01_data_smoke_and_sparse_graph.ipynb", "02_linear_modes_and_dynamics.ipynb", "03_one_step_haken_coarsening.ipynb"])
